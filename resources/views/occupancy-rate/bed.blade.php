...
@section('main-content')
    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <div class="bg-white rounded p2 m-2 shadow-sm">
                <h2>Quarterly</h2>
                {{-- grafik quarter --}}
                <form action="{{ url('/occupancy-rate/bed') }}" class="form-inline" method="GET">
        ...
        <div class="col-md-6 col-sm-12">
            <div class="bg-white rounded p-2 m-2 shadow-sm">
                <h2>Year on year</h2>
                {{-- grafik year on year --}}
                <form action="{{ url('/occupancy-rate/bed') }}" class="form-inline p-2">
    ...
    <div class="bg-white rounded p-2 m-2 shadow-sm">
        ...
        <form action="{{ url('/occupancy-rate/bed') }}" class="form-inline p-2" method="GET">
            <input type="hidden" name="start" value="{{ $start_year }}">
            <input type="hidden" name="end" value="{{ $end_year }}">
            <input type="hidden" name="quarter_year" value="{{ $quarter_year }}">
