...
<div class="row my-5">
    <div class="col-md-6">
        <div class="bg-white rounded p-2">
            ...
            {!! $dg_by_origin_by_quarter->container() !!}
    ...
    <div class="col-md-6">
        <div class="bg-white rounded p-2">
            ...
            {!! $dg_by_origin_by_year->container() !!}
        </div>
    </div>
</div>
...
<div class="row my-5">
    <div class="col-md-12">
        <div class="bg-white rounded p-2">
            ...
            {!! $dg_by_origin_by_month->container() !!}
        </div>
    </div>
</div>
...
<script src="{{ LarapexChart::cdn() }}"></script>
    {{ $dg_by_origin->script() }}
    {{ $dg_by_origin_donut->script() }}
    {{ $dg_by_origin_by_month->script() }}
    {{ $dg_by_origin_by_quarter->script() }}
    {{ $dg_by_origin_by_year->script() }}
@endsection
